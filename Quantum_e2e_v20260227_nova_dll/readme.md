...
├── Quantum_e2e_20260227_nova_dll_file2_toolname.py  # 主程序
└── readme.md
```
...
```bash
python Quantum_e2e_20260227_nova_dll_file2_toolname.py
```
...
python Quantum_e2e_20260227_nova_dll_file2_toolname.py --process_all

# 仅主 Excel，循环 3 轮
python Quantum_e2e_20260227_nova_dll_file2_toolname.py --process_main --cycle 3

# 仅文档注册
python Quantum_e2e_20260227_nova_dll_file2_toolname.py --process_document

# 仅 Memory 数据
python Quantum_e2e_20260227_nova_dll_file2_toolname.py --process_memory

# 本地模式（会自动关/开 WiFi）
python Quantum_e2e_20260227_nova_dll_file2_toolname.py --test_mode local --process_main

# 指定版本与等待时间
python Quantum_e2e_20260227_nova_dll_file2_toolname.py --version_config v20260227 --min_wait_time 1 --max_wait_time 5
```
