...
class MultimodalAPI:
    ...
    def process_main_excel_only(self, cycle=1, resource_csv_path=None):
        """
        仅处理主Excel文件，支持循环执行，每次都从第一行开始处理
        ...
        self.cycle_output_paths = cycle_output_paths
        self.execution_timestamp = execution_timestamp
...
#                     # 添加资源数据到结果文件
#                     if success and resource_csv_path and os.path.exists(resource_csv_path):
#                         execution_timestamp = getattr(api, 'execution_timestamp', timestamp)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--excel_dir', type=str, default=r"C:\Users\XiaoXinPro 16 IAH\Desktop\LRIA_llm_eval\eval\Quantum_e2e_v20251112_nova_R19\dataset\Brain+Latency+Case+2025-11-13_nova_1124.xlsx", help='Excel文件目录路径')
    parser.add_argument('--image_dir', type=str, default=r"C:\Users\XiaoXinPro 16 IAH\Desktop\LRIA_llm_eval\eval\Quantum_e2e_v20251031\images", help='是否需要用到pathlist')
    parser.add_argument('--doc_dir', type=str, default=r"C:\Users\XiaoXinPro 16 IAH\Desktop\LRIA_llm_eval\eval\20251114\files1114", help='文档目录路径')
    parser.add_argument('--memory_excel', type=str, default=r"C:\Users\XiaoXinPro 16 IAH\Desktop\LRIA_llm_eval\eval\Quantum_e2e_v20251112_nova_R19\Memory_data _v3_1016.xlsx", help='Memory Excel文件路径')
