...
if __name__ == "__main__":
    ...
    parser.add_argument('--excel_dir', type=str, default=r"C:\Users\woel0\Desktop\LRIA_llm_eval\eval\Quantum_e2e_v20251225_nova_dll\dataset20260106\Memory_KBQA-30-1210-ocr&layout_filesearchv20250104.xlsx", help='Excel文件目录路径')
    parser.add_argument('--image_dir', type=str, default=r"C:\Users\woel0\Desktop\LRIA_llm_eval\eval\Quantum_e2e_v20251225_nova_dll\image", help='是否需要用到pathlist')
    parser.add_argument('--doc_dir', type=str, default=r"C:\Users\woel0\Desktop\LRIA_llm_eval\eval\Quantum_e2e_v20251225_nova_dll\Reg_Documents\KBQA-30-1208-ocr&layout", help='文档注册,文档的路径')
    parser.add_argument('--memory_excel', type=str, default=r"C:\Users\woel0\Desktop\LRIA_llm_eval\eval\Quantum_e2e_v20251225_nova_dll\Memory_data _v6_260104.xlsx", help='Memory注册,Excel文件路径')
