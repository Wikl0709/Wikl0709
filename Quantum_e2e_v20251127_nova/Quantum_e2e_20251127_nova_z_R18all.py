...
if __name__ == "__main__":
    ...
    parser.add_argument('--excel_dir', type=str, default=r"C:\Users\19867\Desktop\LRIA_llm_eval\eval\Quantum_e2e_v20251121_nova\dataset1126\test.xlsx", help='Excel文件目录路径')
    parser.add_argument('--image_dir', type=str, default=r"C:\Users\19867\Desktop\LRIA_llm_eval\eval\Quantum_e2e_v20251121_nova\files1114\yl\document", help='是否需要用到pathlist')
    parser.add_argument('--doc_dir', type=str, default=r"C:\Users\19867\Desktop\LRIA_llm_eval\eval\Quantum_e2e_v20251121_nova\files1114\Files20251126", help='文档目录路径')
    parser.add_argument('--memory_excel', type=str, default=r"C:\Users\19867\Desktop\LRIA_llm_eval\eval\Quantum_e2e_v20251121_nova\Memory_data _v3_1016.xlsx", help='Memory Excel文件路径')
