...
# 量子SDK客户端配置
# ------------------------------
# DLL_PATH = r"C:\Users\obe\quantum-sdk-1.0.8.dll"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--excel_dir', type=str, default=r"C:\Users\obe\Desktop\LRIA_llm_eval\eval\Quantum_e2e_v20251215_nova_dll\dataset1126\test.xlsx", help='Excel文件目录路径')
