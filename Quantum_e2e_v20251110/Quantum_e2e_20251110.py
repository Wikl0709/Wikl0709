...
if __name__ == "__main__":
    ...
    parser.add_argument('--excel_dir', type=str, default=r'C:\Users\XiaoXinPro 16 IAH\Desktop\LRIA_llm_eval\eval\Quantum_e2e_v20251106\dataset', help='Excel文件目录路径')
    ...
    parser.add_argument('--doc_dir', type=str, default=r"C:\Users\XiaoXinPro 16 IAH\Desktop\LRIA_llm_eval\eval\Quantum_e2e_v20251106\Bvt1110\bvtfiles", help='文档目录路径')
