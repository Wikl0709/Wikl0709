...
if __name__ == "__main__":
    ...
    # parser.add_argument('--dll_path', type=str, default=r"C:\Users\obe\Desktop\LRIA_llm_eval\eval\Quantum_e2e_v20251217_nova_dll\quantum-sdk-1.0.8.dll", help='量子SDK DLL文件路径') 
    parser.add_argument('--excel_dir', type=str, default=r"C:\Users\obe\Desktop\LRIA_llm_eval\eval\Quantum_e2e_v20251217_nova_dll\dataset20251215", help='Excel文件目录路径')
    ...
    parser.add_argument('--memory_excel', type=str, default=r"C:\Users\obe\Desktop\LRIA_llm_eval\eval\Quantum_e2e_v20251217_nova_dll\Memory_data _v3_1016.xlsx", help='Memory注册,Excel文件路径')
