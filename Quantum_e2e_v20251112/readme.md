...
```bash
python Quantum_e2e_20251110.py
```
...
1. **执行完整流程**:
   ...
   ```bash
   python Quantum_e2e_20251110.py --process_all
   ```
2. **处理特定文档目录**:

   ```bash
   python Quantum_e2e_20251110.py --doc_dir /path/to/documents --process_document
   ```
3. **执行多次循环测试**:

   ```bash
   python Quantum_e2e_20251110.py --cycle 3 --process_all
   ```
4. **指定 GPU 类型**:

   ```bash
   python Quantum_e2e_20251110.py --gpu_type dGPU --process_all
   ```
